 ...
 *
 * SVN $Revision: 3961 $
 * SVN $Date: 2011-11-15 14:21:13 +0000 (Tue, 15 Nov 2011) $
 */
...
typedef enum
{
    ADC0_1P5V = 0,      /*!< 1.5V/GND */
    ABPS0 = 1,          /*!< Active Bipolar Pre-Scaler input 1 */
    ABPS1 = 2,          /*!< Active Bipolar Pre-Scaler input 2 */
    CM0 = 3,            /*!< Current Monitor Block */
    TM0 = 4,            /*!< Temperature Monitor Block */
    ADC0 = 5,           /*!< Direct Input 0 */
    ADC1 = 6,           /*!< Direct Input 1 */
    ADC2 = 7,           /*!< Direct Input 2 */
    ADC3 = 8,           /*!< Direct Input 3 */
    ADC4 = 9,           /*!< Direct Input 4 */
    ADC5 = 10,          /*!< Direct Input 5 */
    ADC6 = 11,          /*!< Direct Input 6 */
    ADC7 = 12,          /*!< Direct Input 7 */
    ADC8 = 13,          /*!< Direct Input 8 */
    ADC9 = 14,          /*!< Direct Input 9 */
    ADC10 = 15,          /*!< Direct Input 10 */
...
/*-------------------------------------------------------------------------*//**
  The ACE_set_comp_reference() function is used to select the reference input of
  a odd-numbered comparator. The reference input of an odd-numbered comparator
  can be an ADC direct input or one of the SDD's outputs.
  
  @param comp_id
    The comp_id parameter specifies the comparator for which to select the
    reference input. Since only odd-numbered comparators have a selectable
    reference input, allowed values are:
        - CMP1
        - CMP3
        - CMP5
        - CMP7
  ...
  @param reference
    The reference parameter specifies the signal that will be used as reference
...
/*-------------------------------------------------------------------------*//**
  The ACE_convert_to_uA() function converts a PPE sample value into microamps.
  The result of the conversion is only meaningful if the PPE sample value
  results from the conversion of a current monitor input.
  ...
  @return
    The ACE_convert_to_uA() returns the number of microamps derived from the
    PPE sample value passed as parameter.
 */
...
/*-------------------------------------------------------------------------*//**
  The ACE_convert_from_uA() function converts a current value given in
  microamps into the PPE sample value that would result from sampling this
  current value on the analog input channel specified as parameter.
  The result of the conversion is only meaningful if the analog input channel
  specified as parameter is configured as a current monitoring channel.
  ...
  @param current
    The current parameter is the microamps current value for which we want this
    function to return the associated PPE sample result value.
  
  @return
    The ACE_convert_from_uA() returns the PPE sample value that would be produced
    if the analog input channel identified by channel_handle was set to the
    current value passed as second parameter.
 */
...
/*-------------------------------------------------------------------------*//**
  ...
  @param temperature
    The temperature parameter is the degrees Celsius temperature value, given in
    tenths of degrees Celsius for which we want this function to return the
    associated PPE sample result value.
