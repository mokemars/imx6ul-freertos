...
#if LV_MEM_CUSTOM == 0
#define LV_MEM_SIZE    (54U * 1024U)        /*Size memory used by `lv_mem_alloc` in bytes (>= 2kB)*/
...
#define LV_INDEV_DRAG_LIMIT             1                     /*Drag threshold in pixels */
#define LV_INDEV_DRAG_THROW             20                     /*Drag throw slow-down in [%]. Greater value means faster slow-down */
#define LV_INDEV_LONG_PRESS_TIME        500                    /*Long press time in milliseconds*/
#define LV_INDEV_LONG_PRESS_REP_TIME    250                    /*Repeated trigger period in long press [ms] */
...
/*Slider button(dependencies: lv_bar)*/
#define USE_LV_SLIDER_BUTTON    1
